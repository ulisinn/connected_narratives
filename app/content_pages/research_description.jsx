...
const ResearchDescription = () => {
  return (<div id="research_description" className="content">
      ...
      <div className="contentBody">Biomusic, by enabling others to “tune in” to meaningful changes in an individual’s
        ...
        abused, which raises a number of overlapping <span className="contentBodyEm">everyday ethical, aesthetic and practical concerns</span>
        that must be addressed before it can be meaningfully integrated into everyday life. <span
          className="contentBodyIt">Everyday ethics</span>, an
        emerging field of philosophical inquiry in fields ranging from ethnographic, first- person anthropology
        (Mattingly, 2012;
        Mattingly, 2014; Lambek, 2015; Keane, 2015) to neuroscience (Zizzo et al., 2016) and philosophy (Massumi, 2002)
