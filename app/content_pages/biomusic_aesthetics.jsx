...
const BiomusicAesthetics = () => {
  return (<div id="biomusic_aesthetics" className="content">
    ...
    <div className="contentBody">
      ...
      <span className="contentBodyEm"><a
      ...
      individual will be available for participants to “tune in” to on the smartphone. After a 90-minute period to
      explore the exhibits, participants will be able observe or join in an improvisatory movement session with
      professional dancer (Lee) in the Atelier. The variety of physiological responses of the participants to various
      multi-modal experiences will also provide feedback on how certain exhibit pathways and the newly renovated space
      of the Atelier impacts on the experiences of a range of visitors. Thus, this component, designed in collaboration
      with an arts educator (Lajeunesse), art historians (Park, Tembeck), and museology graduate student (Laurin) poses
      questions about the potentialities and ethical considerations around privacy, power and representation.
    </div>
